...
temp->getLocation()->zipcode.contains(m_stringFilter, Qt::CaseInsensitive) ||
        ...
        {
            Vendor* temp = NULL;
            VendorCat* cat = m_campaign->getVendorCat(m_idCategory);
    ...
    {
        Product* temp = NULL;
        ProductCat* cat = m_campaign->getProductCat(m_idCategory);
    ...
    {
        PLU* temp = NULL;
        PLUCat* cat = m_campaign->getPLUCat(m_idCategory);
...
void CampaignModel::setupHeaders()
{
    ...
    //qDebug() << "campaignmodel : m_listHeaders" << m_listHeaders;
}
...
QVariant CampaignModelItem::value(const int p_column, int role) const
{
    ...
    case Type_Discount:
        {
            ...
            case 3:
                ...
                break;
            case 4:
                return object->getExpirationDate().toString(Qt::DefaultLocaleShortDate);
                break;
            }
            break;
        }
    ...
    case Type_Order:
        {
        //qDebug() << "Type_Order p_column = " << p_column;
            ...
            case 2:
                ...
                break;
            case 3:
                return object->getDate().toString(Qt::DefaultLocaleShortDate);
                break;
            case 4:
